...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      s_setup_wizard: 'Setup Wizard',
      setup_wizard_hint: 'Generate secrets.json by logging into Google in an embedded browser, instead of running a separate GoogleFindMyTools instance.',
      open_setup_wizard: 'Open Setup Wizard',
      s_register_device: 'Add a tracker',
      register_device_hint: "Register a new generic BLE/FMDN tracker (e.g. this project's own ESP32 firmware) with your Google account. Requires the setup wizard (or an existing GoogleFindMyTools login) to have run at least once.",
      f_device_name: 'Name',
      register_device_button: 'Register',
      register_device_done: 'Registered successfully.',
      register_device_key_hint: 'Advertisement key — copy it now, it will not be shown again. Flash it into the tracker’s own firmware.',
      copy: 'Copy',
      copied: 'Copied.',
      theme_light: 'Light',
      theme_dark: 'Dark',
      ...
      s_reset_history: 'Reset device history',
      reset_history_hint: "Delete a device's location history while keeping its name, colour and group. This cannot be undone.",
      reset_history_button: 'Reset history',
      reset_confirm_q: 'Permanently delete all {n} location points for "{name}"? Its name, colour and group are kept. This cannot be undone.',
      reset_confirm_go: 'Reset',
    ...
    de: {
      ...
      s_setup_wizard: 'Setup-Assistent',
      setup_wizard_hint: 'Erzeugt secrets.json über einen eingebetteten Browser-Login bei Google, ohne eine separate GoogleFindMyTools-Instanz zu benötigen.',
      open_setup_wizard: 'Setup-Assistent öffnen',
      s_register_device: 'Tracker hinzufügen',
      register_device_hint: 'Registriert einen neuen generischen BLE/FMDN-Tracker (z. B. die eigene ESP32-Firmware dieses Projekts) bei deinem Google-Konto. Setzt voraus, dass der Setup-Assistent (oder eine bestehende GoogleFindMyTools-Anmeldung) mindestens einmal gelaufen ist.',
      f_device_name: 'Name',
      register_device_button: 'Registrieren',
      register_device_done: 'Erfolgreich registriert.',
      register_device_key_hint: 'Advertisement Key — jetzt kopieren, er wird nicht erneut angezeigt. In die Firmware des Trackers flashen.',
      copy: 'Kopieren',
      copied: 'Kopiert.',
      theme_light: 'Hell',
      theme_dark: 'Dunkel',
      ...
      s_reset_history: 'Verlauf eines Geräts zurücksetzen',
      reset_history_hint: 'Löscht den Standortverlauf eines Geräts, behält aber Name, Farbe und Gruppe. Das lässt sich nicht rückgängig machen.',
      reset_history_button: 'Verlauf zurücksetzen',
      reset_confirm_q: 'Alle {n} Standortpunkte von „{name}" endgültig löschen? Name, Farbe und Gruppe bleiben erhalten. Das lässt sich nicht rückgängig machen.',
      reset_confirm_go: 'Zurücksetzen',
